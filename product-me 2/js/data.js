...
export const WHY_I_BUILT_THIS = {
  ...
  intro: "This site is itself a product decision. Here's the case study behind it, held to the same standard as everything else on this page.",
  fields: [
    { label: "User", value: "[CONTENT NEEDED]" },
    { label: "Job to be done", value: "[CONTENT NEEDED]" },
    { label: "Problem", value: "[CONTENT NEEDED]" },
    { label: "Hypothesis", value: "[CONTENT NEEDED]" },
    { label: "Information architecture", value: "[CONTENT NEEDED]" },
    { label: "Key product decisions", value: "[CONTENT NEEDED]" },
    { label: "Tradeoffs", value: "[CONTENT NEEDED]" },
    { label: "Experiments", value: "[CONTENT NEEDED]" },
    { label: "Results", value: "[CONTENT NEEDED]" },
    { label: "What I learned", value: "[CONTENT NEEDED]" },
  ],
};
